...
DetailProperty detailPropertyFromJson(String str) => DetailProperty.fromJson(json.decode(str));

String detailPropertyToJson(DetailProperty data) => json.encode(data.toJson());
